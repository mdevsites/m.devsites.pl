                                ...
                                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                    ...
                                    <div className="flex items-center justify-end" style={{ paddingTop: '1rem' }}>
                                        <button
                                            ...
                                            className="group w-full md:w-auto rounded-full border border-white/20 hover:border-white/40 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all duration-300 flex flex-col items-center justify-center"
                                        >
                                            {status === 'loading' ? (
                                                <>
                                                    <div className="h-5" />
                                                    <span className="flex items-center justify-center">
                                                        ...
                                                        <div className="w-4" />
                                                        <span className="text-white/70 text-sm tracking-widest uppercase">Wysyłanie...</span>
                                                        <div className="w-12" />
                                                    </span>
                                                    <div className="h-5" />
                                                </>
                                                ...
                                                <>
                                                    ...
                                                    <div className="flex items-center">
                                                        <div className="w-12" />
                                                        <span className="text-white text-sm md:text-base font-medium tracking-widest uppercase">Wyślij zapytanie</span>
                                                        <div className="w-4" />
